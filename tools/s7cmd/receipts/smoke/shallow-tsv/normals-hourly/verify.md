# Verifier — `s7cmd` / mode `shallow-tsv`

**Verdict: PASS**

| | |
| --- | --- |
| Scope | `delimiter=/ prefix=normals-hourly/` |
| Fields checked | keys only — this mode exposed none of size/etag/mtime/storage_class on any of 6 rows |
...
| Expected keys | 6 |
| Emitted records | 6 (multiset, pre-dedup) |
| Distinct keys | 6 |
| Duplicates | 0 |
| Missing | 0 |
| Extra | 0 |
