...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:08:41Z |
| Exit code | `0` |
| Wall-clock | 0.495s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 23.1 MB | `VmHWM` of the container's main process, 8 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 11.4 MB | cgroup v2 `memory.peak`, whole container tree, 8 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: external — `receipts/s7cmd/recursive-tsv.noaa-normals-pds.normals-hourly_.anonymous.stdout.txt` (299225 bytes, sha256 `5230d81171de1f32c609f300be66bf589a1f9b8c73238cc392e9a3a92822d2bd`) — redacted and scanned before hashing; published as a release asset at publication
- stderr: inline — `stderr.txt` (876 bytes, sha256 `bb9ed99160f29c353e900b254aaa15363cccc45ff2602dd73f73c1816882d095`)
