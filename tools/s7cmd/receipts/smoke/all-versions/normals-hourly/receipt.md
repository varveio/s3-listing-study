# Smoke receipt — `s7cmd` / mode `all-versions`
...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:12:16Z |
| Exit code | `0` |
| Wall-clock | 0.990s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 23.9 MB | `VmHWM` of the container's main process, 17 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 12.5 MB | cgroup v2 `memory.peak`, whole container tree, 18 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: external — `receipts/s7cmd/all-versions.noaa-normals-pds.normals-hourly_.anonymous.stdout.txt` (311970 bytes, sha256 `dd5f0662ff8c4236d58b49235f687848c594ac361fd8b841f3e4480561c923bf`) — redacted and scanned before hashing; published as a release asset at publication
- stderr: inline — `stderr.txt` (876 bytes, sha256 `203643119b2ca8808903b9035eb007ec881a8214cc21b0ddf55a386fd7f89395`)
