# Smoke receipt — `s7cmd` / mode `bucket-list`
...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:12:49Z |
| Exit code | `1` |
| Wall-clock | 0.194s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 18.3 MB | `VmHWM` of the container's main process, 3 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 7.2 MB | cgroup v2 `memory.peak`, whole container tree, 3 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
**not exposed for this run** — no `api_calls=` line captured on stderr.

## Raw output

- stdout: inline — `stdout.txt` (0 bytes, sha256 `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`)
- stderr: inline — `stderr.txt` (1328 bytes, sha256 `bac3ab3af9c0268ed66fef53963becfef1550ba091a026f392c291cb7d55f8a0`)
