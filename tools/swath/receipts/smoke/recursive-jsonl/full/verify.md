# Verifier — `swath` / mode `recursive-jsonl`
...
| --- | --- |
| Scope | `full` |
| Fields checked | size 148917/148917; etag 148917/148917; mtime 148917/148917; storage_class 148917/148917 rows compared (by policy) |
