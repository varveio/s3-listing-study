# Verifier — `swath` / mode `recursive-aligned`
...
| --- | --- |
| Scope | `full` |
| Fields checked | size 148917/148917; etag 0/148917; mtime 148917/148917; storage_class 0/148917 rows compared (by policy) |
