...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:29:07Z |
| Exit code | `0` |
| Wall-clock | 0.562s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 29.1 MB | `VmHWM` of the container's main process, 10 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 19.0 MB | cgroup v2 `memory.peak`, whole container tree, 10 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: external — `receipts/s5cmd/recursive.noaa-normals-pds.normals-hourly_.anonymous.stdout.txt` (289037 bytes, sha256 `ae43958326cf464bb376b9736ed4c104b6f22f6b73c0681509776f0406c30a12`) — redacted and scanned before hashing; published as a release asset at publication
