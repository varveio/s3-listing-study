...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:09:26Z |
| Exit code | `0` |
| Wall-clock | 16.958s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 40.3 MB | `VmHWM` of the container's main process, 312 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 30.4 MB | cgroup v2 `memory.peak`, whole container tree, 312 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: external — `receipts/s5cmd/recursive.noaa-normals-pds.full.anonymous.stdout.txt` (19451962 bytes, sha256 `f7978ea26f104aa6776e95df6b3dc21c8006d5f78d7d0787d62c608683f4d1d7`) — redacted and scanned before hashing; published as a release asset at publication
