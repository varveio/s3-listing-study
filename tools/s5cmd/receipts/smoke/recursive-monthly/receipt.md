...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:11:58Z |
| Exit code | `0` |
| Wall-clock | 2.250s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 37.6 MB | `VmHWM` of the container's main process, 41 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 27.9 MB | cgroup v2 `memory.peak`, whole container tree, 41 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: external — `receipts/s5cmd/recursive.noaa-normals-pds.normals-monthly_1991-2020_.anonymous.stdout.txt` (1640937 bytes, sha256 `bf2cb07d57931facab4cedd65d800d2dc1d1b267ae36a87a760b930168d8f0f2`) — redacted and scanned before hashing; published as a release asset at publication
