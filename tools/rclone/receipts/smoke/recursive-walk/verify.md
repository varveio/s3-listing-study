# Verifier — `rclone` / mode `recursive-walk`

**Verdict: PASS**

| | |
| --- | --- |
| Scope | `prefix=normals-annualseasonal/1981-2010/` |
| Fields checked | size 9841/9841; etag 0/9841; mtime 9841/9841; storage_class 9841/9841 rows compared (by policy) |
...
| Expected keys | 9841 |
| Emitted records | 9841 (multiset, pre-dedup) |
| Distinct keys | 9841 |
| Duplicates | 0 |
| Missing | 0 |
| Extra | 0 |
