...
| Exit code | `0` |
| Wall-clock | 0.515s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 65.9 MB | `VmHWM` of the container's main process, 9 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
...
- stdout: inline — `stdout.txt` (100403 bytes, sha256 `27cb07d9a31fa76125ac646a83781386c4cd612f9e19fc5d189a88e61115c247`)
- stderr: inline — `stderr.txt` (96 bytes, sha256 `0b60a44f6a90c132c86377731ab8251cb7b6e104aad1e941bbf2580d0e751712`)
