...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T12:05:57Z |
| Exit code | `0` |
| Wall-clock | 5.055s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 28.0 MB | `VmHWM` of the container's main process, 92 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 17.5 MB | cgroup v2 `memory.peak`, whole container tree, 92 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: external — `receipts/s3-fast-list/list.noaa-normals-pds.normals-monthly_1991-2020_.anonymous.stdout.txt` (906973 bytes, sha256 `4a8df1aec4dec4e05184dba57a65f65d1d2f4c05041c071d597d2dd58c8a4375`) — redacted and scanned before hashing; published as a release asset at publication
- stderr: inline — `stderr.txt` (1346 bytes, sha256 `0263e158bafdae176d8560db67e0aa07035d4a293931e6f68a7c9b72f88448fd`)
