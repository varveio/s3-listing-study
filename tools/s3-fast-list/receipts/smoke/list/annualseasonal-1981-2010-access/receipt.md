...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T12:06:03Z |
| Exit code | `0` |
| Wall-clock | 5.062s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 23.8 MB | `VmHWM` of the container's main process, 92 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 12.9 MB | cgroup v2 `memory.peak`, whole container tree, 92 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: external — `receipts/s3-fast-list/list.noaa-normals-pds.normals-annualseasonal_1981-2010_access_.anonymous.stdout.txt` (571720 bytes, sha256 `6e798e1bc4199d2ee5d6c6f97ec5ddfa420a09401926f73b991fa139e65ced5f`) — redacted and scanned before hashing; published as a release asset at publication
- stderr: inline — `stderr.txt` (1359 bytes, sha256 `6743ad6cc096f6543cce91c6a711e90b551ff8a48be3d0cedecfb7bbc139d46c`)
