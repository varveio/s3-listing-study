# Verifier — `aws-cli` / mode `s3-ls-delimiter`
...
| Fields checked | size 1/5; etag 0/5; mtime 1/5; storage_class 0/5 rows compared (by policy); 4 row(s) exposed none and were checked on key only |
