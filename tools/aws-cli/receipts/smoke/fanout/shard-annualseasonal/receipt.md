...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:19:28Z |
| Exit code | `0` |
| Wall-clock | 8.684s (container lifetime, StartedAt→FinishedAt) |
...
| Region | `us-east-1` |
| Prefix scope | `normals-annualseasonal/`normals-annualseasonal/ |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 79.9 MB | `VmHWM` of the container's main process, 160 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 66.0 MB | cgroup v2 `memory.peak`, whole container tree, 160 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- LIST requests (derived): **49** — 48,784 objects
- Evidence: [INFERRED from ceil + [OBS --debug] `_capability/README.md`]

## Raw output

- stdout: external — `receipts/aws-cli/s3api-v2-text.noaa-normals-pds.normals-annualseasonal_.anonymous.stdout.txt` (6311221 bytes, sha256 `76399d635f5d6610cea2d7379b7a8b8e011fc86a14904c68a63ab57205c16615`) — redacted and scanned before hashing; published as a release asset at publication
