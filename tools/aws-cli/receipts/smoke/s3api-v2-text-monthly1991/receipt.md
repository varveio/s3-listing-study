...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:14:55Z |
| Exit code | `0` |
| Wall-clock | 2.991s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 79.8 MB | `VmHWM` of the container's main process, 54 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 65.8 MB | cgroup v2 `memory.peak`, whole container tree, 54 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- LIST requests (derived): **16** — 15,625 objects
- Evidence: [INFERRED from ceil + [OBS --debug] `_capability/README.md`]

## Raw output

- stdout: external — `receipts/aws-cli/s3api-v2-text.noaa-normals-pds.normals-monthly_1991-2020_.anonymous.stdout.txt` (1946574 bytes, sha256 `595e5c62d79e78025052ca918b05f562b8abf2d96059e08544cc7ce59de89611`) — redacted and scanned before hashing; published as a release asset at publication
