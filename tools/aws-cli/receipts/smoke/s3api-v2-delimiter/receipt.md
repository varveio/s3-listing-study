# Smoke receipt — `aws-cli` / mode `s3api-v2-delimiter`
...
| | |
| --- | --- |
| Date (UTC) | 2026-07-17T08:18:31Z |
| Exit code | `0` |
| Wall-clock | 0.625s (container lifetime, StartedAt→FinishedAt) |
...
| | | |
| --- | --- | --- |
| `peak_rss` | 76.7 MB | `VmHWM` of the container's main process, 11 successful samples. **Main process only** — a multi-process fan-out mode's children are not included. |
| `cgroup_peak_mem` | 62.0 MB | cgroup v2 `memory.peak`, whole container tree, 11 successful samples. **Page cache and kernel/socket memory included. Never present this as RSS.** |
...
- stdout: inline — `stdout.txt` (709 bytes, sha256 `2cfa1a5b3850b09f8cc8940eb599710088b198ad5cc113288c0d0bbb4f2005d8`)
