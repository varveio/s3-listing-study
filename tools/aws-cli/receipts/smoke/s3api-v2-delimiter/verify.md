# Verifier — `aws-cli` / mode `s3api-v2-delimiter`
...
| Fields checked | size 1/5; etag 1/5; mtime 1/5; storage_class 1/5 rows compared (by policy); 4 row(s) exposed none and were checked on key only |
