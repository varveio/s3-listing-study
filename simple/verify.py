...
This production candidate uses plain UTF-8 text
...
def verify_leaves(
    *,
    ...
    actual_expected = {"tool": tool, "bucket": bucket, "prefix": prefix, "mode": mode}
...
def validate_captured_artifacts(local_leaf: Path, result: dict[str, object]) -> None:
    """Bind normalized bytes to the hashes recorded before result.json was sealed."""
