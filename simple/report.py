...
This production candidate prints human-readable Markdown rather than the
audit implementation's byte-identical frozen template.
...
from verify import has_result_marker, read_bytes_at, resolve_leaf, verdict_for
...
def recompute_verification(
    ...
    return code in verify.VERDICT_EXIT_CODES.values() and recomputed == verification
