"""Tests for s3_listing_study.collect: row counts and Parquet conversion."""
...
from s3_listing_study.collect import CollectError, _collect
...
def test_non_utf8_normalized_output_refuses_parquet_conversion_rather_than_corrupt(
    ...
    from s3_listing_study.collect import _write_parquet
